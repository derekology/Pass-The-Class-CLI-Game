...
class TestReadGameIntro(TestCase):
    ...
    def test_read_game_intro_with_an_empty_file(self, mock_output, _):
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_read_game_intro_with_a_one_line_file(self, mock_output, _):
        read_game_intro("test_read_game_intro.py")
        actual = mock_output.getvalue()
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_read_game_intro_with_a_file_with_more_than_one_line(self, mock_output, _):
        read_game_intro("test_read_game_intro.py")
        actual = mock_output.getvalue()
        expected = "\nThis is one line in my file.\n" \
                   "\nThis is a second line in my file.\n" \
