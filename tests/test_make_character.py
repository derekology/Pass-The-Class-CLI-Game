...
class TestMakeCharacter(TestCase):
    ...
    def test_make_character_with_a_one_word_name(self, _):
        expected = {"Name": "Name", "X-coordinate": 0, "Y-coordinate": 0, "Reeses": 5,
    ...
    def test_make_character_with_a_name_containing_space(self, _):
        expected = {"Name": "Test Name", "X-coordinate": 0, "Y-coordinate": 0, "Reeses": 5,
                    "Luck": 1, "Smarts": 1, "Level": 1}
        actual = make_character()
        self.assertEqual(expected, actual)
    ...
    def test_make_character_with_a_name_containing_number(self, _):
        expected = {"Name": "1314", "X-coordinate": 0, "Y-coordinate": 0, "Reeses": 5,
                    "Luck": 1, "Smarts": 1, "Level": 1}
        actual = make_character()
        self.assertEqual(expected, actual)
    ...
    def test_make_character_with_a_mixed_character_name(self, _):
        expected = {"Name": "HaX0R321!", "X-coordinate": 0, "Y-coordinate": 0, "Reeses": 5,
                    "Luck": 1, "Smarts": 1, "Level": 1}
        actual = make_character()
        self.assertEqual(expected, actual)
